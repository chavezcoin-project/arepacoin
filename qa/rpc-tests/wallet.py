...
#   c) node1 mines 32 blocks, so now node 0 has 60001arc, node 1 has 4250arc, node2 has none.
#   d) node0 sends 601 arc to node2, in two transactions (301 arc, then 300 arc).
