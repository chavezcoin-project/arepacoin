...
// Possible states for zARC send
enum ZerocoinSpendStatus {
    ZARC_SPEND_OKAY = 0,                            // No error
    ZARC_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZARC_WALLET_LOCKED = 2,                         // Wallet was locked
    ZARC_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZARC_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZARC_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZARC_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZARC_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZARC_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZARC_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZARC_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZARC_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZARC_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZARC_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZARC_SPENT_USED_ZARC = 14                       // Coin has already been spend
};
